/**
 * POST /api/admin/registrations/:clientId/reject
 */
...
export async function POST(req: NextRequest, { params }: { params: { clientId: string } }) {
  ...
  await db.update(idDocuments)
    .set({ verificationStatus: 'rejected', verifiedBy: adminId, verifiedAt: now })
  ...
  await logAudit({
    ...
    details: { clientUserId: client.userId, reason },
